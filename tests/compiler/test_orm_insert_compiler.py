...
def test_extension_table(books, model_compiler, context):
...
def test_multiple_join_alias_in_different_order(books, model_compiler, context):
    '''
...
def test_parameter_compiler(books, model_compiler, context):
