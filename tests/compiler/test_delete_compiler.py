...
def test_multiple_unique_columns(books, model_compiler, context):
    table_name = 'books'
...
def test_combined_unique_columns(books, model_compiler, context):
    table_name = 'books'
...
def test_with_joins(books, model_compiler, context):
    table_name = 'books'
...
def test_delete_by_foreign_key(books, model_compiler, context):
    table_name = 'books'
...
def test_delete_by_composed_foreign_keys(books, model_compiler, context):
    table_name = 'books'
...
def test_delete_by_double_join(books, model_compiler, context):
    table_name = 'books'
...
def test_delete_by_self_join(books, model_compiler, context):
    table_name = 'books'
